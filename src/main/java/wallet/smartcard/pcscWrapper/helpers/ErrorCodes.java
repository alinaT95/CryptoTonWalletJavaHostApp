...
public class ErrorCodes {
    ...
    static {
        ...
        addError(SW_INCORRECT_PIN, "Incorrect PIN.                                                                                 ");
    ...
    public static String getMsg(ResponseAPDU apduAnswer) {
        byte[] swBytes = {(byte) apduAnswer.getSW1(), (byte) apduAnswer.getSW2()};
        short sw = Util.getShort(swBytes, (short)0);
        String swFormatted = hex(sw);
        String msg = codeToMsg.get(sw);
